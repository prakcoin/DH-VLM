...
from tools.archive_tools import get_look_images, get_look_composition, get_collection_summary, get_item_counts
...
def archive_assistant(query: str) -> str:
    ...
    try:
        archive_agent = Agent(
            ...
            tools=[get_look_images, get_look_composition, get_collection_summary, get_item_counts, retrieve]
        )
